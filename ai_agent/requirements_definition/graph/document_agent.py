...
from .data_models.interview import InterviewResult
from .data_models.persona import Personas
from .elicitron.information_evaluator import InformationEvaluator
from .elicitron.interview_conductor import InterviewConductor
from .elicitron.persona_generator import PersonaGenerator
from .elicitron.requirements_document_generator import RequirementsDocumentGenerator
...
class DocumentationAgent:
    ...
    def _evaluate_information(self, state: InterviewState) -> dict[str, Any]:
        # 情報の評価
        evaluation_result: EvaluationResult = self.information_evaluator.run(  # noqa: F821
